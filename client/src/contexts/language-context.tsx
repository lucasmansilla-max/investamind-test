...
const translations = {
  en: {
    ...
    community: {
      ...
      postShared: "Your {type} has been shared with the community",
      loadingPosts: "Loading posts...",
      noPostsYet: "No posts yet. Be the first to share something!",
      postDeactivated: "Post deactivated",
      postDeactivatedSuccess: "The post has been deactivated successfully",
      postReactivated: "Post reactivated",
      postReactivatedSuccess: "The post has been reactivated successfully",
      deactivated: "Deactivated",
      error: "Error",
      deactivateError: "Could not deactivate the post",
      reactivateError: "Could not reactivate the post",
      confirmDeactivate: "Are you sure you want to deactivate this post?",
      confirmReactivate: "Are you sure you want to reactivate this post?",
      reactivatePost: "Reactivate post",
      advertisement: "Advertisement",
      advertisementDesc: "Publish an official announcement (Admin only)",
      adminOnly: "Admin Only",
      announcement: "Announcement",
      deactivatePost: "Deactivate post",
      createPostType: "Create {type}",
      post: "Post",
      cancel: "Cancel",
      content: "Content",
      tags: "Tags",
      addTags: "Add relevant tags...",
      ...
      messageTypeDescriptions: {
        analysis: "Share your technical or fundamental analysis",
        prediction: "Make a price prediction with reasoning",
        signal: "Share entry/exit points with targets",
        education: "Teach others about trading concepts",
        news: "Share and discuss market news",
        question: "Get help from the community",
  ...
  es: {
    ...
    community: {
      ...
      postCreatedSuccess: "¡Publicación creada exitosamente!",
      postShared: "Tu {type} ha sido compartido con la comunidad",
      loadingPosts: "Cargando publicaciones...",
      noPostsYet: "Aún no hay publicaciones. ¡Sé el primero en compartir algo!",
      postDeactivated: "Publicación desactivada",
      postDeactivatedSuccess: "La publicación ha sido desactivada exitosamente",
      postReactivated: "Publicación reactivada",
      postReactivatedSuccess: "La publicación ha sido reactivada exitosamente",
      deactivated: "Desactivada",
      error: "Error",
      deactivateError: "No se pudo desactivar la publicación",
      reactivateError: "No se pudo reactivar la publicación",
      confirmDeactivate: "¿Estás seguro de que deseas desactivar esta publicación?",
      confirmReactivate: "¿Estás seguro de que deseas reactivar esta publicación?",
      reactivatePost: "Reactivar publicación",
      advertisement: "Anuncio",
      advertisementDesc: "Publicar un anuncio oficial (Solo administradores)",
      adminOnly: "Solo Admin",
      announcement: "Anuncio",
      deactivatePost: "Desactivar publicación",
      createPostType: "Crear {type}",
      post: "Publicar",
      cancel: "Cancelar",
      content: "Contenido",
      tags: "Etiquetas",
      addTags: "Agregar etiquetas relevantes...",
      ...
      messageTypes: {
        ...
        prediction: "Predicción de Precio",
      ...
      messageTypeDescriptions: {
        analysis: "Comparte tu análisis técnico o fundamental",
        prediction: "Haz una predicción de precio con razonamiento",
        signal: "Comparte puntos de entrada/salida con objetivos",
        education: "Enseña a otros sobre conceptos de trading",
        news: "Comparte y discute noticias del mercado",
        question: "Obtén ayuda de la comunidad",
